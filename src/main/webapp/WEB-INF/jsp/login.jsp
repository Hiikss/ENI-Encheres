...
<%@ include file="/WEB-INF/jsp/bandeauErreur.jspf" %>
	<form action="<%=request.getContextPath()%>/login" method="post" class="mt-5">
  		<div class="form-group row justify-content-center">
    		<label for="identifiant" class="col-4 col-md-3 col-lg-2 col-form-label ">Identifiant :</label>
	...
	<div class="row justify-content-center mt-5">
		<a href="<%=request.getContextPath()%>/signup" class="col-8 col-md-5 col-lg-3 p-4 btn btn-outline-primary" role="button">Créer un compte</a>
	</div>
</section>
</body>
</html>